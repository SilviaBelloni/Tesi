...
\usepackage{listings} %per inserire codice sorgente del programma
...
\AfterBegin{itemize}{\addtolength{\parskip}{- 7pt}}
%%\AfterBegin{description}{\addtolength{\itemsep}{- 9pt}}
\AfterBegin{enumerate}{\addtolength{\itemsep}{- 7pt}}
