...
%PROBLEMA: questa section, e solo questa, dà problemi per le andate a capo. Mah.
...
% PROBLEMA:andare a capo dentro un item di un elenco puntato ``appiccica" il testo!!
...
\begin{figure}
 \centering
 \includegraphics[scale=.50]{img/CAP1QD.jpg}
...
Un pregio di questa classe di fluorofori è legato agli spettri di eccitazione e di emissione: il primo risulta pressochè continuo e molto ampio, mentre il secondo è particolarmente piccato e simmetrico. 
